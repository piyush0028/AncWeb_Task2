...
import OutreachsTabItem from "./OutreachsTabItems";
import outreachsTabData from "./outreachsTabData";
    ...
    <>
      ...
      <section className="relative pb-20 pt-18.5 lg:pb-22.5">
        <div className="relative mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          >
            {outreachsTabData.map((outreach, key) => (
              <div
                className={outreach.id === currentTab ? "block" : "hidden"}
                key={key}
              >
                <OutreachsTabItem outreachTab={outreach} />
              </div>
            ))}
          </motion.div>
          {/* <!-- Tab Content End --> */}
