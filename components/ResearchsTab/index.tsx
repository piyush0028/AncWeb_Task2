...
import ResearchsTabItem from "./ResearchsTabItems";
import researchsTabData from "./researchsTabData";
    ...
    <>
      ...
      <section className="relative pb-20 pt-18.5 lg:pb-22.5">
        <div className="relative mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          >
            {researchsTabData.map((research, key) => (
              <div
                className={research.id === currentTab ? "block" : "hidden"}
                key={key}
              >
                <ResearchsTabItem researchTab={research} />
              </div>
            ))}
          </motion.div>
          {/* <!-- Tab Content End --> */}
